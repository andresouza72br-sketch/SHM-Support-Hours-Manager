...
export function ConfiguracoesSistemaPage() {
  ...
  const handleAtualizar = async () => {
    try {
      await refetch()
      toast.success('Diagnósticos e configurações da agenda atualizados!')
    } catch {
      toast.error('Falha ao atualizar diagnósticos da agenda.')
    }
  }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
          <div>
            <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2.5">
              ...
              <span>Configurar Calendar</span>
            </h1>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Parametrização global da agenda corporativa, diagnósticos em tempo real da Service Account e testes da Google API.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              title="Abrir Guia Calendar de configuração e manutenção"
            >
              <BookOpen className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
              <span>Guia Calendar</span>
            </button>
            ...
            <button
              ...
              title="Recarregar diagnósticos da agenda"
            >
